...
export default function ListingsTable({ data, isLoading }: ListingsTableProps) {
  ...
  const filteredData = useMemo(() => {
    ...
    return dataArray.filter((item) => {
      ...
      const exchangeMatch =
        item.exchange_code !== undefined &&
        item.exchange_code !== null &&
        item.exchange_code !== "" &&
        item.exchange_code.toLowerCase().includes(lowercasedTerm);
      const typeMatch =
        item.security_type !== undefined &&
        item.security_type !== null &&
        item.security_type !== "" &&
  ...
  const sortedData = useMemo(() => {
    if (sortField === undefined || sortField === null || sortField === "")
      return filteredData !== undefined && filteredData !== null
        ? filteredData
        : [];
            ...
            >
              ...
              <TableCell>
                <TableSortLabel
                  ...
                  direction={
                    sortField === "exchange_code" ? sortDirection : "asc"
                  }
              ...
              <TableCell>
                <TableSortLabel
                  ...
                  direction={
                    sortField === "listing_date" ? sortDirection : "asc"
                  }
            ...
            {sortedData.length === 0 ? (
              ...
              sortedData.map((listing, index) => (
                <TableRow
                  key={
                    listing.id ||
                    `${listing.exchange_code}-${listing.symbol}` ||
                    index
                  }
                  hover
                  sx={{
                ...
                >
                  ...
                  <TableCell>
                    <Box sx={{ display: "flex", alignItems: "center" }}>
                      ...
                      {listing.listing_detail_url !== undefined &&
                        listing.listing_detail_url !== null &&
                  ...
                  <TableCell>
                    <Chip
                      label={
                        listing.exchange_code !== undefined &&
                        listing.exchange_code !== null &&
                  ...
                  <TableCell>
                    {listing.listing_date
                      ? dayjs(listing.listing_date).format("ll")
                      : "N/A"}
                  </TableCell>
                  <TableCell align="right">
                    {listing.lot_size || "N/A"}
                  </TableCell>
                  <TableCell>
                    {listing.status === "Trading" ||
                    listing.status?.includes("Trading") ? (
