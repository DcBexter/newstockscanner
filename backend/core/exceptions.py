...
class CircuitBreakerError(ScraperError):
    ...
    def __init__(self, message: str = None, url: str = None):
        super().__init__(
            message or "Circuit breaker is open - target service appears to be down",
            status_code=503,
            url=url
        )
...
class TimeoutError(ScraperError):
    ...
    def __init__(self, message: str = None, url: str = None, timeout: int = None):
        ...
        super().__init__(
            message or f"Request timed out{timeout_msg}",
            status_code=408,
            url=url
        )
...
class RateLimitError(HTTPError):
    ...
    def __init__(self, message: str = None, retry_after: int = None, url: str = None):
        ...
        super().__init__(
            status_code=429,
            message=f"{message or 'Rate limit exceeded'}{retry_msg}"
        )
        self.url = url
...
class ConnectionError(ScraperError):
    ...
    def __init__(self, message: str = None, url: str = None):
        super().__init__(
            message or "Failed to connect to server",
            status_code=503,
            url=url
        )
