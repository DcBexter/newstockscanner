...
class StatsService:
    ...
    async def _get_summary_stats(
        ...
        try:
            ...
            raise DatabaseError(f"Failed to get summary statistics: {str(e)}") from e
    ...
    async def _get_exchange_stats(
        ...
        try:
            ...
            raise DatabaseError(f"Failed to get exchange statistics: {str(e)}") from e
    ...
    async def _get_daily_counts(
        ...
        try:
            ...
            raise DatabaseError(f"Failed to get daily counts: {str(e)}") from e 
